...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const chevronIcon = seeMoreLink.querySelector('i');
    ...
    seeMoreLink.addEventListener('click', function (e) {
        ...
        if (isExpanded) {
            ...
            seeMoreLink.innerHTML = '<span>A bit about me</span><i class="fa-solid fa-chevron-down text-xs mt-0.5"></i>';
        } else {
            // Expand
            shortText.classList.add('hidden');
            fullText.classList.remove('hidden');
            seeMoreLink.innerHTML = '<span>See less</span><i class="fa-solid fa-chevron-up text-xs mt-0.5"></i>';
        }
